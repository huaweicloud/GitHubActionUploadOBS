...
ls -al
./$decompressingDirectory/obsutil config -i=${INPUT_ACCESS_KEY} -k=${INPUT_SECRET_KEY} -e=obs.cn-north-4.myhuaweicloud.com  
./$decompressingDirectory/obsutil cp ${INPUT_FILE_PATH} obs://hdn-github-action/ -f -r
